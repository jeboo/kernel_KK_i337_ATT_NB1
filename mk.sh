...
export ARCH=arm
export CROSS_COMPILE=/home/none/android/toolchains/prebuilts-gcc-linux-x86-arm-arm-eabi-4.6/bin/arm-linux-androideabi-
...
if [ -e $KERNELDIR/arch/arm/boot/zImage ]; then
	...
	rm ramdisk.gz
	rm zImage
	zip -r ../Jeboo_Kernel_i337_$curdate.zip .
	cd $KERNELDIR
else
